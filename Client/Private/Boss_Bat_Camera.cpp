...
CBoss_Bat_Camera::CBoss_Bat_Camera(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    :CPartObject{ pDevice, pContext }
{
}

CBoss_Bat_Camera::CBoss_Bat_Camera(const CBoss_Bat_Camera& Prototype)
    :CPartObject(Prototype)
{
}

HRESULT CBoss_Bat_Camera::Initialize_Prototype()
{
...
HRESULT CBoss_Bat_Camera::Initialize(void* pArg)
{

    strcpy_s(m_szName, "BOSS_BAT_CAMERA");
...
void CBoss_Bat_Camera::Priority_Update(_float fTimeDelta)
{
...
void CBoss_Bat_Camera::Update(_float fTimeDelta)
{
...
void CBoss_Bat_Camera::Late_Update(_float fTimeDelta)
{

    m_iPreParentState = *m_pParentState;
}

HRESULT CBoss_Bat_Camera::Render()
{
...
HRESULT CBoss_Bat_Camera::Ready_Components()
{
...
HRESULT CBoss_Bat_Camera::Bind_ShaderResources()
{

    return S_OK;
}

void CBoss_Bat_Camera::OnCollisionEnter(CGameObject* _pOther, PxContactPair _information)
{

}

void CBoss_Bat_Camera::OnCollision(CGameObject* _pOther, PxContactPair _information)
{

}

void CBoss_Bat_Camera::OnCollisionExit(CGameObject* _pOther, PxContactPair _information)
{

}

CBoss_Bat_Camera* CBoss_Bat_Camera::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CBoss_Bat_Camera* pInstance = new CBoss_Bat_Camera(pDevice, pContext);
...
CGameObject* CBoss_Bat_Camera::Clone(void* pArg)
{
    CBoss_Bat_Camera* pInstance = new CBoss_Bat_Camera(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX("Failed To Cloned : CBoss_Bat_Camera");
        Safe_Release(pInstance);
    }
