...
void CJoker_Weapon::Priority_Update(_float fTimeDelta)
{
	...
	if (m_iPreAnimIndex != m_pParentModelCom->Get_Current_Animation_Index() || m_pParentModelCom->Get_CurrentAnmationTrackPosition() == 0.f)
	{
...
HRESULT CJoker_Weapon::Ready_Components()
{
	...
	/* Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Elite_Joker_Weapon"),
