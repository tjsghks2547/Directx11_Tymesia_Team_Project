...
CAttack_LButton_4::CAttack_LButton_4()
{
}

HRESULT CAttack_LButton_4::Initialize()
{
	return S_OK;
}

void CAttack_LButton_4::Priority_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
...
void CAttack_LButton_4::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

void CAttack_LButton_4::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

CAttack_LButton_4* CAttack_LButton_4::Create()
{
	CAttack_LButton_4* pInstance = new CAttack_LButton_4();

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : Attack_LButton_4");
