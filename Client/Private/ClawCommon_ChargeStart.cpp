...
CClawCommon_ChargeStart::CClawCommon_ChargeStart()
{
}

HRESULT CClawCommon_ChargeStart::Initialize()
{
	return S_OK;
}

void CClawCommon_ChargeStart::Priority_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
...
void CClawCommon_ChargeStart::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

void CClawCommon_ChargeStart::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

CClawCommon_ChargeStart* CClawCommon_ChargeStart::Create()
{
	CClawCommon_ChargeStart* pInstance = new CClawCommon_ChargeStart();
...
void CClawCommon_ChargeStart::Free()
{
	__super::Free();
}
