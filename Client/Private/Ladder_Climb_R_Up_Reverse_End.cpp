...
CLadder_Climb_R_Up_Reverse_End::CLadder_Climb_R_Up_Reverse_End()
{
}

HRESULT CLadder_Climb_R_Up_Reverse_End::Initialize()
{
	return S_OK;
}

void CLadder_Climb_R_Up_Reverse_End::Priority_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
...
void CLadder_Climb_R_Up_Reverse_End::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

void CLadder_Climb_R_Up_Reverse_End::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

CLadder_Climb_R_Up_Reverse_End* CLadder_Climb_R_Up_Reverse_End::Create()
{
	CLadder_Climb_R_Up_Reverse_End* pInstance = new CLadder_Climb_R_Up_Reverse_End();
...
void CLadder_Climb_R_Up_Reverse_End::Free()
{
	__super::Free();
}
