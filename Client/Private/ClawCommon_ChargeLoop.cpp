...
CClawCommon_ChargeLoop::CClawCommon_ChargeLoop()
{
}

HRESULT CClawCommon_ChargeLoop::Initialize()
{
	return S_OK;
}

void CClawCommon_ChargeLoop::Priority_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
		...
		|| m_pGameInstance->isKeyPressed(DIK_S) && m_pGameInstance->isKeyPressed(DIK_D))
	{
		...
		if (m_pGameInstance->isKeyPressed(DIK_W) && m_pGameInstance->isKeyPressed(DIK_A))
		{
			...
			pGameObject->Get_Transfrom()->Turn_Degree(XMVectorSet(0.f, 1.f, 0.f, 0.f), Radian * fTimeDelta * 5.f);
...
void CClawCommon_ChargeLoop::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

void CClawCommon_ChargeLoop::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

CClawCommon_ChargeLoop* CClawCommon_ChargeLoop::Create()
{
	CClawCommon_ChargeLoop* pInstance = new CClawCommon_ChargeLoop();

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : ClawCommon_ChargeLoop");
...
void CClawCommon_ChargeLoop::Free()
{
	__super::Free();
}
