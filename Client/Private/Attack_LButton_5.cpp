...
CAttack_LButton_5::CAttack_LButton_5()
{
}

HRESULT CAttack_LButton_5::Initialize()
{
	return S_OK;
}

void CAttack_LButton_5::Priority_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
...
void CAttack_LButton_5::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

void CAttack_LButton_5::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

CAttack_LButton_5* CAttack_LButton_5::Create()
{
	CAttack_LButton_5* pInstance = new CAttack_LButton_5();

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : Attack_LButton_5");
