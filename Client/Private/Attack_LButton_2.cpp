...
CAttack_LButton_2::CAttack_LButton_2()
{
}

HRESULT CAttack_LButton_2::Initialize()
{
	return S_OK;
}
...
void CAttack_LButton_2::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

void CAttack_LButton_2::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{

}

CAttack_LButton_2* CAttack_LButton_2::Create()
{
	CAttack_LButton_2* pInstance = new CAttack_LButton_2();

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : Attack_LButton_2");
