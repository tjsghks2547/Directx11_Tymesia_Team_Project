...
CPlayerSprint::CPlayerSprint()
{
}

HRESULT CPlayerSprint::Initialize()
{
	return S_OK;
}

void CPlayerSprint::Priority_Update(CGameObject* pGameObject, class CNavigation* pNavigation, _float fTimeDelta)
{
...
void CPlayerSprint::Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
}

void CPlayerSprint::Late_Update(CGameObject* pGameObject, CNavigation* pNavigation, _float fTimeDelta)
{
}

CPlayerSprint* CPlayerSprint::Create()
{
	CPlayerSprint* pInstance = new CPlayerSprint();
