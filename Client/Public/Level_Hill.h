...
class CLevel_Hill final : public CLevel
{
private:
	CLevel_Hill(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_Hill() = default;
...
public:
	static CLevel_Hill* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
