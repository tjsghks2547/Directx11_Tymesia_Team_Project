...
class CLadder_Climb_R_Up_Reverse_End final : public CState
{
private:
	CLadder_Climb_R_Up_Reverse_End();
	virtual ~CLadder_Climb_R_Up_Reverse_End() = default;
...
public:
	static CLadder_Climb_R_Up_Reverse_End* Create();
