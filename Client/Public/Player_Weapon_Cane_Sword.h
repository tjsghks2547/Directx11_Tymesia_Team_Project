...
class CPlayer_Weapon_Cane_Sword final : public CPartObject
{
public:
...
private:
	CPlayer_Weapon_Cane_Sword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer_Weapon_Cane_Sword(const CPlayer_Weapon_Cane_Sword& Prototype);
	virtual ~CPlayer_Weapon_Cane_Sword() = default;
...
public:
	static  CPlayer_Weapon_Cane_Sword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
