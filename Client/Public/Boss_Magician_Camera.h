...
class CBoss_Magician_Camera final : public CPartObject
{
public:
...
private:
	CBoss_Magician_Camera(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBoss_Magician_Camera(const CBoss_Magician_Camera& Prototype);
	virtual ~CBoss_Magician_Camera() = default;
...
public:
	static  CBoss_Magician_Camera* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
