...
class CPlayer_Weapon_GreadSword final : public CPartObject
{
public:
...
private:
	CPlayer_Weapon_GreadSword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer_Weapon_GreadSword(const CPlayer_Weapon_GreadSword& Prototype);
	virtual ~CPlayer_Weapon_GreadSword() = default;
...
public:
	static  CPlayer_Weapon_GreadSword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
