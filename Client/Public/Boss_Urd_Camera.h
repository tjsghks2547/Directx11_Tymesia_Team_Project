...
class CBoss_Urd_Camera final : public CPartObject
{
public:
...
private:
	CBoss_Urd_Camera(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBoss_Urd_Camera(const CBoss_Urd_Camera& Prototype);
	virtual ~CBoss_Urd_Camera() = default;
...
public:
	static  CBoss_Urd_Camera* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
