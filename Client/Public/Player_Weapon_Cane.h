...
class CPlayer_Weapon_Cane final : public CPartObject
{
public:
...
private:
	CPlayer_Weapon_Cane(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer_Weapon_Cane(const CPlayer_Weapon_Cane& Prototype);
	virtual ~CPlayer_Weapon_Cane() = default;
...
public:
	static  CPlayer_Weapon_Cane* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
